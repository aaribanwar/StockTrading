...
function Footer() {
  return (
    <div className="my-5 bg-body-tertiary border-top pt-3">
      <div className="container">
        <div className="row">
          <div className="col-3 py-3">
            ...
            <div className="row text-muted">
              <div className="col">
                <a
                  href="https://www.linkedin.com/in/aaribanwar/"
              ...
              <div className="col">
                <a
                  href="https://github.com/aaribanwar"
                  className="link-secondary"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div className="col-2 py-2">
            ...
            <br />
            <Link to="/support" className="link-underline link-underline-opacity-0 link-underline-opacity-75-hover">
          ...
          <div className="col-2 py-2">
            ...
            <Link to="/support" className="link-underline link-underline-opacity-0 link-underline-opacity-75-hover">
              <p className="text-muted">How to file link complaint?</p>
            </Link>
            <Link to="/support" className="link-underline link-underline-opacity-0 link-underline-opacity-75-hover">
          ...
          <div className="col-2 py-2">
            ...
            <Link to="/support" className="link-underline link-underline-opacity-0 link-underline-opacity-75-hover">
              <p className="text-muted">Press and Media</p>
            </Link>
            <Link to="/support" className="link-underline link-underline-opacity-0 link-underline-opacity-75-hover">
          ...
          <div className="col-3 py-2">
            ...
            <br />
            <Link to="/support" className="link-underline link-underline-opacity-0 link-underline-opacity-75-hover">
              <p className="text-muted">Upcoming IPOs</p>
            </Link>
            <Link to="/support" className="link-underline link-underline-opacity-0 link-underline-opacity-75-hover">
        ...
        <div className="row mt-2 text-small text-secondary" style={{ fontSize: "11px" }}>
          <p>
            Zerodha Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.: INZ000031633 CDSL/NSDL:
            Depository services through Zerodha Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered
            Address: Zerodha Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P
            Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities
            broking please write to complaints@zerodha.com, for DP related to dp@zerodha.com. Please ensure you
          ...
          <p>
            Attention investors: 1) Stock brokers can accept securities as margins from clients only by way of pledge in
            the depository system w.e.f September 01, 2020. 2) Update your e-mail and phone number with your stock broker /
          ...
          <p>
            ...
            in the interest of investors. KYC is one time exercise while dealing in securities markets - once KYC is done through
            a SEBI registered intermediary (broker, DP, Mutual Fund etc.), you need not undergo the same process again when you
            approach another intermediary." Dear Investor, if you are subscribing to an IPO, there is no need to issue a cheque.
            Please write the Bank account number and sign the IPO application form to authorize your bank to make payment in case
            of allotment. In case of non allotment the funds will remain in your bank account. As a business we don't give stock tips,
            and have not authorized anyone to trade on behalf of others. If you find anyone claiming to be part of Zerodha and offering
            such services, please create a ticket here.
          </p>

          <p>
            *Customers availing insurance advisory services offered by Ditto (Tacterial Consulting Private Limited | IRDAI
            Registered Corporate Agent (Composite) License No CA0738) will not have access to the exchange investor grievance
